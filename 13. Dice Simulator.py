# This program allows the user to select the type of dice and the number of times it will be rolled. Afterwards it prints all outcomes and their percentages
